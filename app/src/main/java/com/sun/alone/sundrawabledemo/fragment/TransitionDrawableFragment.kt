...
import com.sun.alone.sundrawabledemo.databinding.FragmentTransitionDrawableBinding
...
class TransitionDrawableFragment : BaseFragment<FragmentTransitionDrawableBinding>() {
  ...
  override fun initView() {
    binding.transitionDrawableInclude.apply {
      ...
      tv1.background = ContextCompat.getDrawable(requireContext(), R.drawable.transition_drawable)
